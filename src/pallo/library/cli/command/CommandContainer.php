...
class CommandContainer implements AutoCompletable, Countable, Iterator {
     ...
     * @param pallo\library\cli\command\Command $command Command to add
     * @return null
     */
     ...
     * @throws pallo\library\cli\exception\CliException when the provided name
     * is empty or invalid
     */
     ...
     * @param string $name
     * @return Command
     * @throws pallo\library\cli\exception\CliException when the command if not
     * in this container
     */
