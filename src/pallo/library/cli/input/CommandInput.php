...
class CommandInput {
     ...
     * @return null
     * @throws pallo\library\cli\exception\CliException when no argument is
     ...
     * @param pallo\library\input\Input $input
     * @return null
     */
     ...
     * @throws pallo\library\cli\exception\CliException when no input set to
     * wrap around
     */
